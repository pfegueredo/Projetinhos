...
namespace DIO.bank
{
    class Program
    {
        ...
        {
            Console.Write("Digite número da conta de origem: ");
            int indiceContaOrigem = int.Parse(Console.ReadLine());

            Console.Write("Digite número da conta de destino: ");
        ...
        private static void InserirConta()
        {
            ...
            Console.WriteLine("Digite 1 para Conta Física e 2 para Conta Juridica: ");
